package hb.techs.simple_photo_editor.CanEditor;
...
public class JEditor extends LBActivity implements View.OnClickListener {
    ...
    public void onBackPressed() {
        finish();
        startActivity(new Intent(this, WomanIAD.class));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.LL_NoDataFound:
                finish();
                startActivity(new Intent(JEditor.this, WomanIAD.class));
                overridePendingTransition(R.anim.right_in, R.anim.left_out);
                break;
            ...
            public MyViewHolder(View itemView) {
                ...
                this.imageViewIcon.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        ...
                        Intent intent = new Intent(JEditor.this, ZeEdiror.class);
